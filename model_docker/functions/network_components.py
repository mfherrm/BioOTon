...
class EarlyStopping:
    ...
    def __init__(self, model, patience : int = 5, delta : float = 0.001, window : int = 5, path : str ='checkpoints/checkpoint.pt', verbose : bool = True, sftp_config : dict = {}):
    ...
    def check_early_stop(self, val_loss):
        ...
        if current_value<last_value:
            ...
            buffer.seek(0)
            with self.sftp.open(str(self.path), 'wb', bufsize=32768) as f:
